...
def initalizeDB():
    ...
    ai = create_lecturer('capadvisor', 'capadvisor', 'capadvisor@temp.com', 'Cap', 'Adivosr', 9999)
    ...
    cap_advisor = add_proposal(
                steve.id, rubric.id, 'Cap Advisor', 'Students do not always undertsand how to design capstone projects', 'SWEN and COMP students',
                ...
                'May be revised')
    flask_test = add_proposal(
      steve.id, rubric.id, 'Flask Test', 'Students do not always undertsand how to design capstone projects', 'SWEN and COMP students',
      'Students can submit capstone proposals to and have feedback', 'craete a web app which allows them submit proposal according to capstone rubric',
      ...
      'SWEN and COMP students','manged by lecturer eventually','May be revised')
